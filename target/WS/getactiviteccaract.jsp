<%-- 
    Document   : getactiviteccaract
    Created on : 8 févr. 2018, 21:50:59
    Author     : user
--%>
...
<%
    ...
    String cat = request.getParameter("caractere");
    try {
            DB db = mon.getcon();
            ...
            QueryBuilder.start().or(
                    QueryBuilder.start("caractere").regex(Pattern.compile(cat)).get()
            ).get();
